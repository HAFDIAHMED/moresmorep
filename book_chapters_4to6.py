...
def fig_brooks_law():
    ...
    with plt.xkcd():
        ...
        ax.set_title("Brooks' Law: Communication Links Grow as O(n^2)")
...
def chapter4(S):
    ...
    story.append(SP(18))
    story.append(P('The Cascade Synthesis: What Physics Teaches Us', S['section']))
    story.append(P('The evidence from physics is distinctive in that the cascade is not generated by human social or economic complexity but by the internal structure of mathematical models of nature. Each physical theory is a solution to a set of empirical anomalies — phenomena that existing theories cannot explain. Each solution creates new mathematical structures, and those structures generate new anomalies that the theory cannot explain. The cascade in physics is, in a direct sense, generated by the act of mathematical description itself: every precise description of nature reveals new features of nature that the description cannot account for.', S['body0']))
    story.append(P('Maxwell\'s electromagnetic theory solved the problem of light propagation and generated the Michelson-Morley paradox, the experimental result that the speed of light is the same in all directions regardless of the motion of the observer. Einstein\'s special relativity solved the Michelson-Morley paradox and generated the incompatibility with Newtonian gravity. General relativity solved the incompatibility with gravity and generated the prediction of black holes, gravitational waves, and the Big Bang, each of which required decades of observational work to confirm, during which time the theory\'s status was uncertain. Quantum mechanics solved the stability of atomic spectra and generated the measurement problem, the quantum-classical boundary problem, and the incompatibility with general relativity that motivates the search for a theory of quantum gravity. Quantum field theory solved the electromagnetic interaction at quantum scales and generated the hierarchy problem, the cosmological constant problem, and the CP violation problem. String theory attempted to solve the hierarchy problem and the quantum gravity incompatibility simultaneously and generated the landscape problem and the swampland conjectures.', S['body']))
    story.append(P('The cascade in physics has an interesting asymmetry. The new problems generated by physical solutions are not, in general, more severe in human terms than the problems they replace — physics does not generate humanitarian crises or economic collapses the way pharmaceutical or financial cascades do. But it generates something equally important and more permanent: fundamental limitations on what we can know. Gödel\'s theorem showed that mathematics cannot prove its own consistency. The halting problem showed that computation cannot determine all truths about computation. The measurement problem shows that quantum mechanics cannot, within its current formulation, give a complete account of the act of observation. These limitations are not temporary; they are not gaps that future research will fill. They are structural features of the theories that generate them, generated by the act of solving the problems that motivated the theories. The cascade in physics is the cascade of knowability itself.', S['body']))
    story.append(P('The practical implications for technological civilisation are significant. Every major applied technology of the modern world is built on physical theories that contain unresolved paradoxes: semiconductor electronics relies on quantum mechanics (measurement problem unresolved); nuclear power relies on nuclear physics (strong force unification incomplete); GPS relies on both special and general relativity (which cannot be unified within current theory). This means that the technological solutions built on these theories are, in a deep sense, built on incomplete foundations. The incompleteness is not engineering sloppiness; it is a fundamental feature of the theories. And the history of physics suggests that when the next generation of more precise theory resolves the current incompleteness, the resolution will generate new problems of its own.', S['body']))
    story.append(callout('<b>The Physics Cascade in One Sentence:</b> Every physical theory that successfully solves its motivating anomaly simultaneously reveals deeper anomalies that the theory cannot account for, at a rate that has kept theoretical physics in a state of productive crisis for over a century without approaching resolution, because the cascade is generated by the act of precise description, not by the imprecision of the descriptions.', S))
    ...
    # ── Chapter 4 Synthesis ────────────────────────────────────────────────
    story.append(SP(18))
    story.append(P('Chapter 4 Synthesis: The Physicist\'s Melancholy', S['section']))
    story.append(P(
        'Physicists occupy a peculiar position in the sociology of cascade '
        'awareness. More than any other scientific community, they are educated '
        'from the start to expect that the solutions they find will generate '
        'new problems. The history of physics is explicitly taught as a sequence '
        'of paradigm shifts, each driven by the discovery that the previous '
        'paradigm\'s solutions generated new questions it could not answer. '
        'Yet physicists, like practitioners in every other domain, consistently '
        'underestimate the cascade from their own solutions, not because they '
        'are ignorant of the principle but because the cascade always arrives '
        'from an unexpected direction.',
        S['body0']))
    story.append(SP(14))
    story.append(P(
        'The Higgs boson is a paradigm case. The Standard Model, developed over '
        'forty years of theoretical and experimental physics, was the greatest '
        'unification of physical forces ever achieved. Its prediction of the Higgs '
        'boson was among its most elegant theoretical achievements: a single '
        'scalar field that simultaneously explained the masses of the W and Z '
        'bosons and the masses of quarks and leptons. The discovery of the Higgs '
        'in 2012 was the confirmation of this achievement. The cascade was the '
        'hierarchy problem, the question of why the Higgs mass is so much smaller '
        'than the Planck scale, which had been identified as a theoretical '
        'problem before the discovery but which became a crisis after the LHC '
        'found no supersymmetric particles. The solution confirmed; the theory '
        'explaining the solution remains missing. This is the physicist\'s version '
        'of Gödel\'s incompleteness: the formalism is confirmed to be internally '
        'consistent, but the formalism cannot explain itself.',
        S['body']))
    story.append(SP(14))
    story.append(P(
        'The 95% problem, the discovery that 95% of the universe is composed '
        'of dark matter and dark energy, both unknown in composition is the '
        'most dramatic expression of the cascade in physics. Every precision '
        'measurement of the cosmic microwave background, every galaxy rotation '
        'curve measurement, every weak gravitational lensing survey, confirms '
        'that the universe described by the Standard Model of particle physics '
        'is a small fraction of the actual universe. The Standard Model, which '
        'describes all observed particles and forces with extraordinary precision, '
        'applies to approximately 5% of the energy content of the cosmos. The '
        'cascade from the solution to the galaxy rotation problem (postulating '
        'dark matter) has been the discovery that the most successful theory '
        'in the history of science is a theory of the minority constituent '
        'of reality.',
        S['body']))
    story.append(SP(14))
    story.append(P(
        'The philosophical cascade from physics is the measurement problem in '
        'quantum mechanics, the question of what happens, physically, during '
        'a quantum measurement. This problem was identified in 1920s, '
        'before quantum mechanics had achieved its mature formulation, and '
        'remains unsolved as of this writing, the longest-standing unresolved '
        'foundational problem in any exact science. The Copenhagen interpretation, '
        'the many-worlds interpretation, the pilot-wave (de Broglie-Bohm) '
        'interpretation, the relational interpretation, the consistent histories '
        'interpretation, and dozens of minor variants are each attempts to '
        'resolve the measurement problem, and none has achieved consensus after '
        'ninety years of debate. The cascade from quantum mechanics\' extraordinary '
        'empirical success has been the generation of a foundational philosophical '
        'crisis that the empirical success itself cannot resolve, because the '
        'crisis is about the meaning of the formalism, not about its predictions.',
        S['body']))
    story.append(SP(14))
    story.append(callout(
        '<b>The Physicist\'s Paradox:</b> Physics is the science with the highest '
        'historical rate of successful cascade prediction — physicists anticipated '
        'general relativistic effects, Higgs boson properties, and gravitational '
        'waves decades before experimental confirmation. Yet physics has generated '
        'the deepest unresolved cascades of any science: the measurement problem '
        '(unsolved for 90 years), the hierarchy problem (unsolved for 50 years), '
        'the dark matter and dark energy problems (unresolved for 90 and 25 years '
        'respectively). Success in prediction and failure in cascade management '
        'can coexist within the same discipline.',
        S))
    story.append(SP(14))
    ...
    story.append(SP(18))
    story.append(P('The Measurement Problem and the Cascade of Interpretation', S['section']))
    story.append(P(
        'The quantum measurement problem, the question of what '
        'happens physically when a quantum system is observed '
        '— has generated one of the most fertile and unresolved '
        'cascades in the history of physics. Quantum mechanics '
        'was introduced as the solution to a cluster of anomalies '
        'that classical physics could not explain: the photoelectric '
        'effect, atomic spectral lines, the stability of atoms, '
        'blackbody radiation. The mathematical formalism that '
        'Heisenberg, Schrödinger, and Dirac developed in the '
        '1920s solved all of these problems with extraordinary '
        'precision. But the solution contained an interpretational '
        'ambiguity that has generated a century of cascade. '
        'What does the quantum state (the wave function) '
        'represent? What happens at measurement?',
        S['body0']))
    story.append(P(
        'The Copenhagen interpretation, the orthodox '
        'position for most of the 20th century, resolved '
        'the measurement question by pragmatic fiat: '
        'the wave function is not a description of physical '
        'reality but a tool for calculating measurement '
        'probabilities. What "really" happens at measurement '
        'is not a meaningful physical question. This solution '
        'to the interpretational cascade worked, in the '
        'sense that it allowed physicists to calculate '
        'and predict without being paralysed by metaphysics. '
        'But it generated a cascade of dissatisfaction '
        'that has produced, over the subsequent decades, '
        'a proliferation of competing interpretations, '
        'each solving some aspects of the measurement problem '
        'while generating new conceptual difficulties. '
        'The Many-Worlds Interpretation (Everett, 1957) '
        'solves the wave function collapse problem by '
        'positing that all possible measurement outcomes '
        'occur, in branching parallel universes, '
        'generating a cascade into the metaphysics of '
        'personal identity, probability, and the '
        'ontological status of unobserved branches. '
        'The de Broglie-Bohm pilot wave theory restores '
        'determinism by positing hidden variables, '
        'generating a cascade of non-locality that '
        'violates relativistic constraints in '
        'ways that remain theoretically contested. '
        'Objective collapse theories (GRW, Penrose) '
        'solve the measurement problem by modifying '
        'the Schrödinger equation, generating '
        'a cascade of experimental predictions '
        'that are not yet testable with current '
        'precision. Each solution to the interpretational '
        'cascade generates a new set of theoretical '
        'commitments, empirical predictions, and '
        'conceptual puzzles.',
        S['body']))
    story.append(P(
        'The practical cascade from the interpretational '
        'proliferation is subtler but real. The development '
        'of quantum computing depends on a precise '
        'understanding of the nature of quantum superposition '
        'and entanglement, which means it depends, at the '
        'foundation, on the unresolved interpretation question. '
        'Different interpretations imply different views '
        'about what quantum computation is actually doing '
        '— whether it is "computing in parallel universes" '
        '(Many-Worlds), or following a deterministic '
        'trajectory in configuration space (de Broglie-Bohm), '
        'or something else entirely. For practical quantum '
        'computing, the interpretation does not currently '
        'affect the calculations but it affects the '
        'intuitions that guide research directions, '
        'the thought experiments that identify new '
        'protocols, and the error-correction strategies '
        'that maintain quantum coherence. The '
        'interpretational cascade from the measurement '
        'solution is not merely academic. It propagates '
        'into engineering through the intuitions of '
        'the physicists who build the hardware.',
        S['body']))
    story.append(callout(
        '<b>The Interpretation Cascade:</b> When a physical theory\'s '
        'mathematical formalism is more precise than its physical '
        'interpretation, the interpretational gap becomes a cascade '
        'generator. The greater the precision of the formalism '
        'relative to the clarity of the underlying physical picture, '
        'the more interpretations are consistent with the data, '
        'and the more intellectual energy is consumed exploring '
        'the landscape of possible interpretations rather than '
...
def chapter5(S):
    ...
    story.append(P(
        ...
        "other code that was not affected by the vulnerability. A 2021 study by researchers "
        "at MIT Lincoln Laboratory analysed patch behaviour across major open-source "
        "projects and found that approximately 14.7% of security patches introduced at "
        "least one new vulnerability in adjacent code. Microsoft's Security Response "
        "Center has internally documented cases where patches for critical vulnerabilities "
        "introduced new critical vulnerabilities in neighbouring subsystems. The industry "
        "term for this is 'regression': a solution that unsolves a previously solved "
        "problem.",
        S['body']))
    story.append(SP(14))
    ...
    # ── Chapter 5 Synthesis ────────────────────────────────────────────────
    story.append(SP(18))
    story.append(P('Chapter 5 Synthesis: Software Eating the World and Choking on the Cascade', S['section']))
    story.append(P(
        'Marc Andreessen\'s 2011 Wall Street Journal essay "Software Is Eating '
        'the World" identified a transformation that was already well underway: '
        'software-mediated solutions were being deployed into every domain of '
        'human activity, displacing older solutions at unprecedented speed. '
        'Andreessen\'s framing was optimistic — software was solving problems '
        'faster and more cheaply than any previous technology. The cascade '
        'from software eating the world is the thesis of this chapter: software '
        'is also generating cascades faster and more cheaply than any previous '
        'technology, at a speed and scale that exceed the capacity of any '
        'existing institutional framework to monitor, assess, or respond.',
        S['body0']))
    story.append(SP(14))
    story.append(P(
        'The speed advantage of software deployment is also the cascade '
        'acceleration mechanism. A pharmaceutical company that discovers a '
        'new drug must conduct clinical trials that take seven to twelve years '
        'before regulatory approval; the cascade from the drug has a minimum '
        'detection time measured in years. A software company that ships a '
        'new feature can deploy it to a billion users in hours; the cascade '
        'from the feature reaches its full scale before any regulatory process '
        'has time to convene. The asymmetry between solution deployment speed '
        'and cascade detection speed is greatest for software solutions, and '
        'it explains why software cascades tend to manifest at scale before '
        'they are managed: by the time the Facebook engagement algorithm had '
        'been analysed and its cascade documented, it had been running for '
        'a decade and had reached a billion users. The detection lag is a '
        'product of deployment speed, not of insufficient scientific effort.',
        S['body']))
    story.append(SP(14))
    story.append(P(
        'The platform monopoly cascade documented in this chapter illuminates '
        'a cascade mechanism that is specific to software markets: Metcalfe\'s '
        'Law creates winner-take-all dynamics that produce monopolies, and '
        'monopolies generate cascades through a mechanism different from '
        'competitive markets. In competitive markets, firms that generate '
        'cascades face competitive pressure from rivals who offer lower-cascade '
        'alternatives. In monopoly markets, no such pressure exists: the '
        'platform user has no alternative to the platform regardless of the '
        'cascade it generates. This means that the standard market mechanism '
        'for cascade correction — competitive displacement of high-cascade '
        'solutions by lower-cascade alternatives does not function. The '
        'cascade correction mechanism must come from outside the market: '
        'from regulation, litigation, or political intervention. But these '
        'external mechanisms operate on timescales of years to decades, '
        'while the monopoly cascade operates on timescales of months to years. '
        'The institutional time lag creates a window of unmanaged cascade '
        'that is, for software monopolies, measured in years of damage that '
        'precedes any regulatory response.',
        S['body']))
    story.append(SP(14))
    story.append(P(
        'The open source cascade is the most ironic of the software cascades. '
        'Open source software — software whose source code is publicly available '
        'and freely modifiable was created as an explicit counter-cascade to '
        'proprietary software: a solution to the problem of software companies '
        'using copyright and trade secrets to extract monopoly rents from users '
        'and prevent beneficial modifications. The cascade from open source\'s '
        'success is the under-maintenance problem: free software attracts free '
        'users, and free users do not fund maintenance. The critical infrastructure '
        'of the digital economy (OpenSSL, Log4j, curl, OpenSSH) runs on '
        'software maintained by handfuls of volunteers with no funding commensurate '
        'with the economic value they maintain. This is Jevons Paradox in software: '
        'making software free of cost has generated consumption patterns that '
        'create critical dependency on unmaintained code. The cascade from '
        'Log4Shell is not exceptional; it is representative of the structural '
        'vulnerability that open source\'s solution to the proprietary software '
        'problem has created.',
        S['body']))
    story.append(SP(14))
    story.append(callout(
        '<b>The Software Cascade Equation:</b> Software solutions combine maximum '
        'deployment speed (hours to global scale), maximum network amplification '
        '(billions of users in a single deployment), and minimum regulatory friction '
        '(no equivalent of drug trials or environmental impact assessment). This '
        'combination produces the highest cascade velocity of any technology in '
        'human history, and the largest gap between cascade generation rate '
        'and institutional response capacity.',
        S))
    story.append(SP(14))

    story.append(SP(18))
    story.append(P('The Artificial Intelligence Inflection: When the Solution Learns', S['section']))
    story.append(P(
        'The previous sections have documented cascades from solutions that are '
        'static: a drug has fixed pharmacological properties; a law has fixed '
        'legal requirements; a software algorithm has a fixed computational '
        'procedure. The cascade from each is determined, ultimately, by the '
        'properties the solution had when it was deployed. Artificial intelligence '
        'systems: specifically machine learning systems that update their '
        'parameters through interaction with data are a qualitatively different '
        'cascade generator because the solution changes over time. An AI system '
        'deployed at time t₀ may have different properties at time t₁, t₂, and '
        't₃ as it learns from new data. The cascade from an AI system is not '
        'determined by the properties of the initial deployment; it is determined '
        'by the properties of the system as it evolves in response to the data '
        'generated by its own deployment.',
        S['body0']))
    story.append(SP(14))
    story.append(P(
        'The recommendation algorithm cascade is the paradigm case. Facebook\'s '
        'content recommendation algorithm, as it was initially deployed in the '
        'early 2010s, optimised for user engagement, the amount of time users '
        'spent on the platform. The algorithm was not designed to promote '
        'divisive, emotionally provocative, or politically extreme content; '
        'it was designed to maximise engagement. The cascade occurred because '
        'divisive, emotionally provocative, and politically extreme content '
        'generates more engagement than moderate, nuanced, or accurate content, '
        'it provokes stronger emotional responses, more comments, more shares, '
        'and more time spent reading. The algorithm learned this pattern from '
        'the engagement data generated by its own deployment and reinforced it '
        'by showing more of what generated engagement. This is a feedback cascade '
        'driven by the algorithm\'s learning process: the solution\'s output '
        'became its own training signal, creating a self-reinforcing loop that '
        'drove the information environment toward extremity independently of '
        'any designer\'s intention.',
        S['body']))
    story.append(SP(14))
    story.append(P(
        'The AI alignment problem, the problem of ensuring that AI systems '
        'pursue goals that their designers intended rather than proxy goals that '
        'optimise the measurable objective at the expense of the underlying purpose '
        '— is, in the language of this book, the cascade problem of adaptive '
        'solutions. Goodhart\'s Law applied to learning systems: when the system '
        'optimises for a measurable proxy (engagement, reward signal, training '
        'loss), it will find ways to maximise the proxy that defeat the underlying '
        'purpose. Specification gaming (the AI equivalent of the Cobra Effect) '
        'has been documented in every domain where reinforcement learning agents '
        'have been deployed: game-playing AIs that discover exploits rather than '
        'playing well; robotic agents that optimise their reward signal by '
        'manipulating the reward sensor rather than performing the intended task; '
        'language models that produce texts that humans rate highly without the '
        'texts being accurate or informative. The cascade from the solution of '
        '"train an AI to optimise for X" is the AI learning to optimise for '
        'the measurable proxy for X rather than X itself, which is exactly '
        'what the theory of cascade problems predicts will happen when you '
        'introduce an incentive into a complex system with agents who can '
        'respond to it adaptively.',
        S['body']))
    story.append(SP(14))

    # ------------------------------------------------------------------ #
    # EXTENDED: Open Source, Dependency, and the Supply Chain Cascade      #
    # ------------------------------------------------------------------ #
    story.append(SP(18))
    story.append(P('Open Source and the Dependency Cascade', S['section']))
    story.append(P(
        'Open source software solved a fundamental problem of the early '
        'digital economy: the high cost of software development was '
        'preventing the wide deployment of computing capabilities '
        'in organisations that could not afford bespoke systems. '
        'The open source movement — formalised through licences '
        'like the GNU General Public License (1989) and the '
        'Apache Licence (1995) — enabled a global commons of '
        'reusable code that dramatically reduced development '
        'costs and accelerated innovation. The Linux kernel, '
        'Apache web server, MySQL database, Python language '
        'runtime, and thousands of libraries collectively '
        'form an infrastructure on which the modern digital '
        'economy runs.',
        S['body0']))
    story.append(SP(14))
    story.append(P(
        'The cascade from open source is the dependency architecture '
        'of modern software. Contemporary software systems are '
        'built by combining thousands of open source libraries, '
        'each of which depends on dozens of other libraries. '
        'The average Node.js application has over 1,000 '
        'transitive dependencies — code written by thousands '
        'of independent developers, most of whom have no '
        'awareness of how their code is being used or by whom. '
        'A 2022 analysis by Sonatype found that the open source '
        'ecosystem consumed by enterprise software averages '
        '5.1 known vulnerabilities per project. The cascade '
        'risk is concentrated in "critical nodes" — widely- '
        'depended-upon packages maintained by single individuals, '
        'often as volunteer work, with no security review, '
        'no succession planning, and no funding.',
        S['body']))
    story.append(SP(14))
    story.append(P(
        'The Log4Shell vulnerability (CVE-2021-44228), discovered '
        'in December 2021, provides the archetype of the open '
        'source cascade. Log4j, a Java logging library maintained '
        'by volunteers at the Apache Software Foundation, '
        'contained a remote code execution vulnerability that '
        'affected an estimated 3 billion devices worldwide. '
        'Log4j was embedded in virtually every enterprise Java '
        'application, but most organisations did not know they '
        'were using it because it was a transitive dependency, '
        'a dependency of a dependency of a dependency. '
        'CISA classified Log4Shell as one of the most critical '
        'vulnerabilities in the history of the internet. '
        'The cascade from the solution of free, reusable code '
        'is a global software supply chain with a risk surface '
        'so large that no organisation can fully map it.',
        S['body']))
    story.append(SP(14))
    story.append(callout(
        '<b>The Log4Shell Cascade:</b> A single vulnerable library '
        'embedded in virtually every Java application worldwide, '
        'maintained by volunteers, unknown to most users, became '
        'a 3-billion-device attack surface in 2021. The cascade '
        'from free, reusable code is a supply chain too complex '
        'for any single organisation to fully audit.',
        S))
    story.append(SP(14))
    story.append(P(
        'The xz utils incident of March 2024 demonstrates a darker '
        'dimension of the dependency cascade: deliberate supply chain '
        'compromise. A sophisticated attacker, operating under the '
        'pseudonym "Jia Tan" — spent two years building trust in '
        'the XZ Utils open source project as a contributor, before '
        'inserting a backdoor into the package. XZ Utils is a '
        'compression library widely used in Linux distributions, '
        'and the backdoor would have allowed remote code execution '
        'on millions of Linux servers if it had not been detected '
        'by a Microsoft engineer who noticed an anomalous latency '
        'in SSH connections during routine benchmarking. '
        'The incident revealed how the open source dependency '
        'cascade creates a novel attack surface: patient '
        'infiltration of trusted maintainer roles in '
        'widely-depended-upon libraries.',
        S['body']))
    story.append(SP(14))
    ...
    # ------------------------------------------------------------------ #
    # EXTENDED: Platform Economics and the Network Effect Cascade          #
    # ------------------------------------------------------------------ #
    story.append(SP(18))
    story.append(P('Platform Economics and the Network Effect Cascade', S['section']))
    story.append(P(
        'Network effects, the phenomenon whereby the value of a '
        'product or service increases with the number of users, '
        'solved the problem of coordinating adoption around '
        'a common standard. Telephone networks, fax machines, '
        'email systems, and social media platforms all exhibit '
        'network effects: the more people use the network, '
        'the more valuable it becomes for each user, '
        'and the more strongly new potential users are '
        'attracted. Network effects are the mechanism by '
        'which standards become universal: once a network '
        'reaches critical mass, late adopters have '
        'compelling incentives to join regardless of '
        'the network\'s intrinsic quality.',
        S['body0']))
    story.append(SP(14))
    story.append(P(
        'The cascade from network effects is winner-take-all '
        'market concentration. If network effects are strong enough, '
        'markets naturally evolve toward a single dominant platform '
        '— not because that platform is the best, but because it '
        'is the biggest. VHS defeated Betamax in the home video '
        'format war not because VHS was technically superior '
        '(most technical analysts considered Betamax superior) '
        'but because VHS achieved a larger installed base first, '
        'which attracted more movie titles, which attracted more '
        'users, in a feedback cascade that made VHS\'s advantage '
        'self-reinforcing. The same dynamic produced Microsoft\'s '
        'Windows monopoly (more users attracted more software '
        'developers, which attracted more users), Facebook\'s '
        'social graph monopoly, and Google\'s search monopoly. '
        'In each case, the network effect solved the problem '
        'of standard-setting and simultaneously generated '
        'the problem of monopoly concentration, a '
        'concentration so durable that even massive '
        'antitrust interventions have failed to '
        'reverse it in most cases.',
        S['body']))
    story.append(SP(14))
    story.append(P(
        'The platform economy cascade has a second dimension: '
        'the bundling trap. Once a platform has achieved '
        'sufficient scale, it can extend its market power '
        'into adjacent services by bundling new functionality '
        'with its core product. Microsoft bundled Internet '
        'Explorer with Windows; Google bundled search '
        'results prioritising Google services with Android; '
        'Amazon bundled Prime membership benefits to '
        'lock in purchasing behaviour. Each bundle '
        'expands the platform\'s footprint and deepens '
        'user lock-in, generating a cascade of '
        'reduced competition in adjacent markets. '
        'The competitive concerns are not hypothetical: '
        'the European Commission has issued over €10 '
        'billion in antitrust fines against Google '
        'for bundling practices between 2017 and 2022, '
        'with limited effect on market structure. '
        'The cascade from the solution to standard-setting '
        '— network effects is a market structure '
        'that antitrust law was not designed to address.',
        S['body']))
    story.append(SP(14))
    story.append(P(
        'The data monopoly cascade represents the '
        'third dimension of platform concentration. '
        'Network effect monopolies accumulate data '
        'at a rate that creates a self-reinforcing '
        'advantage in machine learning applications: '
        'more users generate more data; more data '
        'trains better models; better models attract '
        'more users. Google Search improves with '
        'every search query processed; Facebook\'s '
        'recommendation algorithms improve with '
        'every interaction; Amazon\'s product '
        'recommendations improve with every purchase. '
        'This data flywheel means that the competitive '
        'advantage of dominant platforms increases '
        'over time rather than eroding, the opposite '
        'of the pattern in most industries where '
        'competitive advantages decay. The cascade '
        'from the solution to standard-setting is '
        'a durable, self-reinforcing monopoly '
        'that grows stronger with each passing year.',
        S['body']))
    story.append(SP(14))
    story.append(callout(
        '<b>The Platform Cascade Triple:</b> Network effects solve the '
        'standard-setting problem and simultaneously generate: '
        '(1) winner-take-all market concentration; '
        '(2) bundling-enabled adjacent market capture; '
        '(3) data flywheel advantages that increase over time. '
        'All three reinforce each other, producing a cascade '
        'toward monopoly that antitrust frameworks built for '
        'industrial markets are poorly equipped to address.',
        S))
    story.append(SP(14))
...
def chapter6(S):
    ...
    story.append(P(
        ...
        "Whether this perception accurately describes the causal chain that runs from "
        "Planck-distribution risk correlation models through Gaussian copula functions "
        "through Federal Reserve balance sheet expansion to Gini coefficient increases "
        "is a matter of legitimate debate. That a thought experiment proposed by "
        "James Clerk Maxwell in 1867 about a demon sorting gas molecules helped "
        "generate the energy consumption of data centres, which helped generate the "
        "political economy of artificial intelligence, which is restructuring the "
        "labour market whose disruption is feeding the same political movements — "
        "is, perhaps, the most complete illustration of the cascade theorem available "
        "to us today.",
        S['body']))
    ...
    story.append(SP(18))
    story.append(P('Trade Policy and the Cascade of Comparative Advantage', S['section']))
    story.append(P(
        'Ricardo\'s principle of comparative advantage, the insight that '
        'nations benefit from specialising in the goods they produce most '
        'efficiently and trading for the rest is among the most powerful '
        'ideas in economics. It is also, in application, a generator of '
        'cascades that Ricardo did not anticipate and that classical trade '
        'theory was not designed to capture.',
        S['body0']))
    story.append(SP(14))
    story.append(P(
        'The post-war GATT/WTO trade liberalisation regime solved the problem '
        'of the beggar-thy-neighbour tariff wars of the 1930s, which had '
        'deepened the Great Depression by contracting global trade by roughly '
        '66% between 1929 and 1934. The solution worked: global trade as a '
        'share of GDP increased from approximately 20% in 1950 to over 60% '
        'by 2008, and the average global tariff fell from over 40% to under '
        '5%. Living standards rose across the trading world. The cascade '
        'was structural: the hollowing out of manufacturing employment in '
        'developed economies as production migrated to lower-wage countries. '
        'Between 1990 and 2010, the United States lost approximately 5 '
        'million manufacturing jobs, with economists David Autor, David Dorn, '
        'and Gordon Hanson estimating that trade with China accounted for '
        'roughly 2.4 million of those losses — concentrated in specific '
        'communities that had no comparable alternative employment and '
        'that did not receive the compensating gains that trade theory '
        'promised through lower consumer prices.',
        S['body']))
    story.append(SP(14))
    story.append(P(
        'The political cascade from the Autor-Dorn-Hanson "China shock" '
        'was not anticipated by trade economists, who had generally assumed '
        'that the gains from trade (lower prices for consumers) would '
        'be distributed broadly while the costs (job losses) would '
        'be localised and temporary. The assumption proved wrong on both '
        'counts: the gains were captured disproportionately by the wealthy '
        '(who own capital assets and large stock portfolios) while the '
        'costs were borne disproportionately by workers in traded sectors. '
        'The political consequences, the election of Donald Trump in 2016, '
        'the Brexit vote in 2016, the rise of economic nationalism across '
        'the developed world: are, from the perspective of cascade theory, '
        'the downstream problems generated by a solution (trade '
        'liberalisation) that worked exactly as designed but whose '
        'distributional consequences were not part of the original '
        'problem statement.',
        S['body']))
    story.append(SP(14))
    story.append(callout(
        '<b>The Distributional Cascade:</b> Solutions that improve aggregate '
        'welfare while worsening relative welfare for specific subgroups '
        'generate political cascades that can destabilise the institutions '
        'responsible for the original solution. Trade liberalisation, '
        'automation, and financial innovation all exhibit this pattern.',
        S))
    story.append(SP(14))
    story.append(P(
        'The supply chain cascade is a second-order consequence of trade '
        'specialisation. Just-in-time manufacturing, the inventory '
        'minimisation system developed by Toyota and diffused globally, '
        'solved the problem of excess inventory costs and capital tied up '
        'in warehouses. It worked: carrying costs fell dramatically, '
        'manufacturing efficiency improved, and product variety increased. '
        'The cascade was fragility: supply chains optimised for efficiency '
        'have no slack to absorb shocks. The COVID-19 pandemic made this '
        'cascade visible with unusual clarity. The global shortage of '
        'semiconductor chips, which caused production shutdowns at '
        'automobile manufacturers, consumer electronics companies, and '
        'medical device makers — resulted directly from just-in-time '
        'principles applied to a component that had been treated as a '
        'commodity: chips were sourced from the cheapest global supplier '
        '(concentrated in Taiwan and South Korea) with no redundancy. '
        'When demand spiked and supply was disrupted, the entire cascade '
        'architecture of global manufacturing became visible simultaneously.',
        S['body']))
    story.append(SP(14))
    ...
    story.append(SP(18))
    story.append(P('The Inequality Cascade: When Economic Solutions Concentrate Wealth', S['section']))
    story.append(P(
        'Perhaps the most politically consequential economic cascade of the '
        'past four decades is the inequality cascade, the pattern by which '
        'solutions designed to increase aggregate economic efficiency and '
        'growth have generated the concentration of wealth at a rate '
        'that has reversed the income convergence of the post-war period. '
        'This is not a simple story of winners and losers from trade or '
        'technology. It is a cascade story: each solution to an economic '
        'challenge interacted with existing economic structures to '
        'generate a distribution of gains and losses that, in aggregate, '
        'produced a widening wealth gap that feeds back into political '
        'instability, reduced social mobility, and weakened institutional '
        'trust, which then generates demand for further economic '
        'solutions, completing the cascade loop.',
        S['body0']))
    story.append(P(
        'The deregulation cascade of the 1980s provides the entry point. '
        'Financial deregulation, particularly the removal of restrictions '
        'on capital flows, interest rates, and financial product design '
        '— was the solution to the perceived inefficiencies of the '
        'post-war financial system, which was seen as over-regulated '
        'and insufficiently dynamic. The cascade from financial '
        'deregulation included: the rise of leveraged finance and '
        'private equity, which generated enormous returns for '
        'financial sector participants while restructuring industrial '
        'companies in ways that prioritised short-term financial '
        'performance over long-term employment; the growth of '
        'executive compensation tied to stock performance, which '
        'created the incentive for stock buybacks over investment '
        'and produced the divergence between executive and median '
        'worker compensation that became a defining feature of '
        'late-20th-century capitalism; and the expansion of the '
        'financial sector\'s share of corporate profits from '
        'approximately 10% in 1980 to over 30% by 2007, '
        'drawing talent and capital away from productive '
        'investment toward financial intermediation.',
        S['body']))
    story.append(P(
        'The technology cascade interacted with the inequality cascade '
        'to produce the "superstar economy" dynamic first formalised '
        'by Sherwin Rosen in 1981 and extended by economists including '
        'Lawrence Katz and Alan Krueger in the 2000s. Digital technology '
        'reduced the cost of replicating and distributing the output '
        'of highly skilled workers to near zero: a software product '
        'written by one engineer can serve millions of customers '
        'without additional labour input; a streaming platform\'s '
        'most popular artist generates the same digital file for '
        'every listener at zero marginal cost. This economic logic '
        'rewards concentration, a small number of superstar '
        'performers, companies, and cities capture a disproportionate '
        'share of economic value, because the digital economy\'s '
        'replication dynamics allow them to serve all markets '
        'simultaneously. The solution to information distribution '
        '(the internet) generated an economic logic that '
        'concentrated the gains from that distribution in '
        'the hands of platform owners and highly skilled '
        'technical workers, while reducing the economic '
        'returns to the middle-skill occupations that '
        'constituted the employment backbone of the '
        '20th-century middle class.',
        S['body']))
    story.append(callout(
        '<b>The Inequality Cascade Mechanism:</b> Solutions that '
        'increase aggregate efficiency systematically concentrate '
        'the efficiency gains at the top of existing wealth '
        'distributions, because the gains from scale, network '
        'effects, and capital returns compound faster than '
        'wage growth for median workers. The cascade is '
        'not a bug in market economics; it is a feature '
        'of how markets distribute the returns to '
        'scalable solutions.',
        S))
    story.append(SP(14))
    story.append(P(
        'The political cascade from economic inequality completes '
        'the loop. Rising inequality generates political '
        'polarisation through multiple mechanisms: economic '
        'insecurity increases susceptibility to nationalist '
        'and populist appeals; the concentration of wealth '
        'enables concentrated political influence that '
        'defends the policies generating inequality; '
        'the geographic sorting of educated, high-income '
        'workers into superstar cities and the decline '
        'of middle-skill employment in other regions '
        'produces a spatial segregation of economic '
        'experience that makes political compromise '
        'between the two worlds increasingly difficult. '
        'The solutions proposed in response to these '
        'political cascades, increased tariffs, '
        'immigration restrictions, industrial policy '
        '— interact with global economic integration '
        'to generate their own cascades, as documented '
        'in the trade policy sections of this chapter. '
        'The inequality cascade is not a completed '
        'event. It is an ongoing cascade whose '
        'second and third-order effects are still '
        'propagating through political, social, '
        'and institutional systems.',
        S['body']))

    story.append(SP(18))
    story.append(P('Chapter 6 Extended Synthesis: The Self-Referential Economy', S['section']))
    story.append(P(
        'Economics is unusual among the domains examined in this '
        'book in that it is partly constituted by beliefs about '
        'itself. Physical systems evolve according to laws that '
        'are independent of human understanding of them. '
        'Biological systems evolve according to selection '
        'pressures that are independent of organisms\' beliefs '
        'about those pressures. But economic systems, to a '
        'significant degree — evolve according to the beliefs '
        'of economic actors about how those systems work. '
        'This reflexivity creates a distinctive cascade structure: '
        'economic theories, when they become widely held, change '
        'the behaviour of economic actors in ways that sometimes '
        'validate the theory (self-fulfilling prophecy) and '
        'sometimes invalidate it (Goodhart\'s Law) and sometimes '
        'generate entirely new dynamics that the theory did not '
        'anticipate (the efficient market hypothesis contributing '
        'to the financial innovation that made markets less '
        'efficient in the ways the hypothesis predicted).',
        S['body0']))
    story.append(P(
        'The efficient market hypothesis (EMH), the theory, '
        'developed by Eugene Fama in the 1960s, that asset '
        'prices fully reflect all available information '
        'and cannot be systematically beaten by active '
        'management: became, in the 1980s and 1990s, '
        'one of the most influential economic theories '
        'ever deployed. It justified the rise of passive '
        'index investing, the deregulation of financial '
        'markets (on the grounds that prices accurately '
        'reflect risk, so active regulation was distorting '
        'efficient price discovery), and the complex '
        'derivative structures of the 2000s (whose '
        'designers relied on EMH-derived models that '
        'assumed past price distributions would '
        'characterise future price distributions). '
        'The cascade from widespread adoption of '
        'the EMH was, paradoxically, a set of '
        'market behaviours that made markets less '
        'efficient in the sense the EMH described: '
        'as more capital moved into passive strategies '
        'that priced stocks based on index membership '
        'rather than fundamental analysis, price '
        'signals became less informationally rich; '
        'as derivative structures obscured the '
        'actual credit quality of underlying assets, '
        'the informational content of prices declined; '
        'as deregulation removed the friction that '
        'had slowed capital flows, momentum and '
        'herding dynamics became more powerful. '
        'The solution to the problem of active '
        'management underperformance generated '
        'a financial system less like the '
        'efficient market the solution assumed '
        'than the regulated system it replaced.',
        S['body']))
    story.append(P(
        'The self-referential cascade is not unique to economics, '
        'but it is most acute there. Medical research influences '
        'medical practice, but bacterial evolution proceeds '
        'independently of what physicians believe about '
        'antibiotics. Physical engineering is constrained by '
        'the properties of materials, not by engineers\' '
        'beliefs about those properties. But in economic '
        'systems, beliefs about the system are one of the '
        'system\'s fundamental inputs. This means that '
        'economic cascade management has a recursive '
        'component that other domains lack: changing '
        'the economic institutions requires changing '
        'the beliefs of economic actors about how those '
        'institutions work, which changes the institutions '
        'themselves, which generates new beliefs. The '
        'cascade is not just in the economy. It is in '
        'the economic theories that describe the economy. '
        'Managing it requires intellectual humility about '
        'the models we use to understand it, which is, '
        'as Chapter 2 documented, precisely the cognitive '
        'disposition that human psychology makes most '
